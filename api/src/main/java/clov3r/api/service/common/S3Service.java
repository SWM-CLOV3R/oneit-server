...
import static clov3r.api.error.errorcode.CustomErrorCode.S3_FILE_EXTENSION_ERROR;
import static clov3r.api.error.errorcode.CustomErrorCode.S3_PUT_OBJECT_ERROR;
import static clov3r.api.error.errorcode.CustomErrorCode.S3_REQUEST_ERROR;
import static clov3r.api.error.errorcode.CustomErrorCode.S3_UPLOAD_ERROR;
import static clov3r.api.error.errorcode.CustomErrorCode.S3_URL_DECODING_ERROR;
