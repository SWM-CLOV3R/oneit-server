package clov3r.api.config.security;

import static clov3r.api.error.errorcode.CustomErrorCode.INVALID_TOKEN;
import static clov3r.api.error.errorcode.CustomErrorCode.NO_AUTHORIZATION_HEADER;

import clov3r.api.error.exception.AuthExceptionV2;
