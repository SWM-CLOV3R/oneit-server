...
import static clov3r.api.error.errorcode.CustomErrorCode.DUPLICATE_FRIEND;
import static clov3r.api.error.errorcode.CustomErrorCode.INVALID_FRIEND_REQUEST;
import static clov3r.api.error.errorcode.CustomErrorCode.INVALID_SELF_REQUEST;
...
import clov3r.api.domain.DTO.RequestFriendDTO;
...
import clov3r.api.service.FriendService;
