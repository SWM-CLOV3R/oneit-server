...
import static clov3r.api.error.errorcode.CustomErrorCode.CANNOT_DELETE_OTHERS_COMMENT;
...
public class CommentController {
  ...
  public ResponseEntity<String> deleteComment(
    ...
    if (!comment.getWriter().getIdx().equals(userIdx)) {
      throw new BaseExceptionV2(CANNOT_DELETE_OTHERS_COMMENT);
    }
