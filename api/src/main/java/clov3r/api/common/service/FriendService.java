...
import clov3r.api.common.domain.DTO.FriendDTO;
import clov3r.api.common.domain.DTO.FriendReqDTO;
import clov3r.api.common.domain.data.status.FriendReqStatus;
import clov3r.api.common.domain.data.status.Status;
import clov3r.api.common.domain.entity.FriendReq;
import clov3r.api.common.domain.entity.Friendship;
import clov3r.api.common.repository.FriendReqRepository;
import clov3r.api.common.repository.FriendshipRepository;
