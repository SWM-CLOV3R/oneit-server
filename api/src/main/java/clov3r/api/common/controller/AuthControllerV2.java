...
import clov3r.api.common.domain.request.UpdateUserRequest;
import clov3r.api.common.config.security.Auth;
import clov3r.api.common.config.security.TokenProvider;
import clov3r.api.common.domain.DTO.KakaoFriendDTO;
import clov3r.api.common.domain.DTO.KakaoLoginDTO;
import clov3r.api.common.domain.DTO.KakaoProfileDTO;
import clov3r.api.common.domain.DTO.NicknameCheckDTO;
import clov3r.api.common.domain.DTO.UserDTO;
import clov3r.api.common.domain.data.AuthToken;
import clov3r.api.common.domain.data.status.UserStatus;
import clov3r.api.common.domain.entity.User;
import clov3r.api.common.domain.request.KakaoAccessToken;
import clov3r.api.common.domain.request.SignupRequest;
import clov3r.api.common.repository.AuthRepository;
import clov3r.api.common.repository.UserRepository;
import clov3r.api.common.service.AuthService;
import clov3r.api.common.service.UserService;
