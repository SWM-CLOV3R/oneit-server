...
echo $FCM_ACCOUNT=$(aws secretsmanager get-secret-value --secret-id $FCM_JSON_NAME --query SecretString --output text) > $REPOSITORY/src/main/resources/firebase/firebase-admin-sdk.json
